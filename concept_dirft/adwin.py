...
class Adwin:
    ...
    def set_input(self, value):
        ...
        # Reduce window
        result = self.__reduce_window()
#        print(self.list_row_buckets.head.bucket_size_row)
...
#                        diff_value = (u0 / n0) - (u1 / n1)
                        if n0 > self.min_length_sub_window + 1 and n1 > self.min_length_sub_window + 1 and \
                                self.__reduce_expression(n0, n1, (u0 / n0), (u1 / n1)):
    ...
    def __reduce_expression(self, n0, n1, val1, val2):
        diff_value = val1 - val2
        ...
        if fabs(diff_value) > epsilon:
            print(val1, val2, epsilon)
            self.val1 = val1
            self.val2 = val2
